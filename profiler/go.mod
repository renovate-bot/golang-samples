...
require (
	...
	github.com/GoogleCloudPlatform/golang-samples v0.0.0-20260424155409-342ce671d151
	google.golang.org/api v0.276.0
)

require github.com/googleapis/enterprise-certificate-proxy v0.3.14 // indirect
