...
require (
	...
	github.com/GoogleCloudPlatform/golang-samples/run/grpc-ping 2c9f7d4fe3c1
	github.com/GoogleCloudPlatform/golang-samples/run/grpc-server-streaming 2c9f7d4fe3c1
