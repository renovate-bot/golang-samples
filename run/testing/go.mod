...
require (
	...
	github.com/GoogleCloudPlatform/golang-samples/run/grpc-ping v0.0.0-20260612210857-2d36f64cc2ee
	github.com/GoogleCloudPlatform/golang-samples/run/grpc-server-streaming v0.0.0-20260612210857-2d36f64cc2ee
